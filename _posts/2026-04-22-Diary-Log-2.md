...
* **直接左递归：** **$P \rightarrow P\alpha\ \vert\ \beta$** （其中 **$P$** 不是 **$\beta$** 的前缀）
* **间接左递归：** **$A \rightarrow N\beta\ \vert\ \gamma$** ；**$N \rightarrow A\alpha$**

**2)**

**i) 消除直接左递归：** **$P \rightarrow \beta P'$** ； **$P' \rightarrow \alpha P'\ \vert\ \epsilon$**

之所以等价，是由于 **$P \rightarrow P\alpha\ \vert\ \beta$**，必有 **$P \Rightarrow \beta\alpha\dots\alpha$** 形式（**$\beta\alpha\dots\alpha$** 的形式），且第一个必为 **$\beta$**。改写为 **$P \rightarrow \beta P'$**，再 **$P' \rightarrow \alpha P'\ \vert\ \epsilon$**

**ii) 消除间接左递归：**

**$N \rightarrow A\alpha$**

**$A \rightarrow N\beta\ \vert\ \gamma$**

（将 **$A$** 代入 **$N$**） **$\Rightarrow$**

**$N \rightarrow \gamma\alpha\ \vert\ N\beta\alpha$**  （转化为直接左递归）
